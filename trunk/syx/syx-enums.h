...
typedef enum
  {
    ...
    SYX_DATA_BLOCK_ALL=SYX_DATA_METHOD_ALL,
    ...
    SYX_DATA_BLOCK_CONTEXT_OUTER_CONTEXT,
    SYX_DATA_BLOCK_CONTEXT_RETURN_CONTEXT,
    SYX_DATA_BLOCK_CONTEXT_HANDLED_EXCEPTION,
    SYX_DATA_BLOCK_CONTEXT_HANDLER_BLOCK,
    SYX_DATA_BLOCK_CONTEXT_ALL,

    SYX_DATA_PROCESS_SCHEDULER_BYTESLICE = SYX_DATA_OBJECT_ALL,
    SYX_DATA_PROCESS_SCHEDULER_ACTIVE_PROCESS = SYX_DATA_OBJECT_ALL,
    SYX_DATA_PROCESS_SCHEDULER_ALL,
