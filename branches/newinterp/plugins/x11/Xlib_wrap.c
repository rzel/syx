...
SYX_FUNC_PRIMITIVE(X11_XInternAtoms)
{
  ...
  SWIG_FIRST_SELF(arg5, Atom *, es->message_arguments[3])
#undef SWIG_APPEND_VALUE
#define SWIG_APPEND_VALUE _SWIG_APPEND_RESULT
  int num_values = 0;
  result_oop = syx_array_new_size (2);
...
SYX_FUNC_PRIMITIVE(X11_XClearArea)
{
  ...
  if (!SYX_IS_BOOLEAN(es->message_arguments[5]))
  {
    SYX_PRIM_FAIL;
  }	   
  arg7 = SYX_IS_TRUE(es->message_arguments[5]);
...
SYX_FUNC_PRIMITIVE(X11_XGetWindowProperty)
{
  ...
  arg6 = SYX_IS_TRUE(es->message_arguments[4]);
  ...
  SWIG_FIRST_SELF(arg10, unsigned long *, es->message_arguments[8])
  SWIG_FIRST_SELF(arg11, unsigned long *, es->message_arguments[9])
  SWIG_FIRST_SELF(arg12, unsigned char **, es->message_arguments[10])
#undef SWIG_APPEND_VALUE
#define SWIG_APPEND_VALUE _SWIG_APPEND_RESULT
  int num_values = 0;
  result_oop = syx_array_new_size (2);
...
SYX_FUNC_PRIMITIVE(X11_XSendEvent)
{
  ...
  SWIG_FIRST_SELF(arg5, XEvent *, es->message_arguments[3])
